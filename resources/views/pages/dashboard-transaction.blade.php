              ...
              <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                ...
                <a href="dashboard-transactions-details.html" class="card card-list d-block">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-1">
                        <img src="{{ asset('images/dashboard-icon-product-1.png') }}" alt="">
                      </div>
                      <div class="col-md-4">
                        Shirup Marzzan
                      </div>
                ...
                <a href="dashboard-transactions-details.html" class="card card-list d-block">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-1">
                        <img src="{{ asset('images/dashboard-icon-product-2.png') }}" alt="">
                      </div>
                      <div class="col-md-4">
                        LeBrone X
                      </div>
                ...
                <a href="dashboard-transactions-details.html" class="card card-list d-block">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-1">
                        <img src="{{ asset('images/dashboard-icon-product-3.png') }}" alt="">
                      </div>
                      <div class="col-md-4">
                        Soffa Lembutte
                      </div>
