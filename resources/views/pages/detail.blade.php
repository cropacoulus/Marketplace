    ...
    <div class="page-content page-details">
        ...
        <section class="store-heading">
            ...
            <div class="row">
                ...
                <div class="owner">By Muhammad Rifki</div>
        ...
        <section class="store-review">
            ...
            <div class="row">
                ...
                <ul class="list-unstyled">
                    <li class="media">
                    <img src="{{ asset('images/icons-testimonial-1.png') }}" alt="" class="mr-3 rounded-circle">
                    ...
                    <li class="media">
                    <img src="{{ asset('images/icons-testimonial-2.png') }}" alt="" class="mr-3 rounded-circle">
                    <div class="media-body">
                    ...
                    <li class="media">
                    <img src="{{ asset('images/icons-testimonial-3.png') }}" alt="" class="mr-3 rounded-circle">
                    <div class="media-body">
